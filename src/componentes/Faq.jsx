      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-4">
          {FAQ.itens.map((item) => (
            ...
            >
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 p-5 font-display text-lg font-extrabold [&::-webkit-details-marker]:hidden">
                {item.p}
                <span
                  className="bloco-sm flex size-8 shrink-0 items-center justify-center rounded-sm bg-ambar text-xl leading-none transition-transform group-open:rotate-45"
                  aria-hidden="true"
                >
                  +
                </span>
